...
const requestOptions = {
  ...
  api(`/api/cart/${cart_item}`, requestOptions)
              ...
              <li >
                <div class = "container">
                  ...
                  <div class="quantity">
                    ...
                    <button class="plus-btn"   v-on:click.prevent="increment"> + </button>
                    <input type = "text" v-model="counts" />
                    <button class="minus-btn"  v-on:click.prevent="decrement"> - </button>
                    <button class="bin"  v-on:click="deletecart(productId = c.productId)" >
